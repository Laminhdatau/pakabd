...
const StockReport = () => {
  ...
  const totalHargaSisaStok = stockItems.reduce((acc, item) => acc + item.hargaSisaStok, 0);
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 mb-6">
        ...
        {/* <div className="bg-white p-4 rounded-lg shadow-md flex items-center justify-between">
          <div>
            <h2 className="text-xl font-semibold text-gray-700">Harga Sisa Stok</h2>
            <p className="text-lg font-bold text-green-600">{USERUPIAH(totalHargaSisaStok)}</p>
          </div>
        ...
        <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
          <thead className="bg-gray-200">
            <tr>
              ...
              {/* <th className="py-2 px-4 text-left text-gray-600">Harga Sisa Stok</th> */}
            </tr>
          </thead>
          <tbody>
            {stockItems.map((item, index) => (
              <tr key={index} className="border-b border-gray-200">
                ...
                {/* <td className="py-2 px-4 text-gray-700">{USERUPIAH(item.hargaSisaStok)}</td> */}
              </tr>
            ))}
          </tbody>
        </table>
